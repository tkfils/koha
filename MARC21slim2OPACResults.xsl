    ...
    <xsl:if test="$typeOf008!=''">
        <span class="label">Type: </span>
            <xsl:choose>
                ...
                <xsl:when test="$leader6='c' or $leader6='d' or $leader6='i' or $leader6='j'"><img src="/opac-tmpl/prog/famfamfam/silk/music.png" alt="score" title="score"/> Sound</xsl:when>
            </xsl:choose>
    </xsl:if>
...
<!-- Added 306 Playing Time field -->
    <xsl:if test="marc:datafield[@tag=306]">
        <span class="results_summary">
    <span class="label">Playing time: </span>
...
<!-- End of 306 added section -->

<!-- Added 511 Participants field -->
...
<!-- End of 511 added section -->

<!-- Added 518 Date and Place field -->
    <xsl:if test="marc:datafield[@tag=518]">
        <span class="results_summary">
    <span class="label">Date and Place: </span>
...
<!-- End of 518 added section -->
    ...
    <xsl:if test="marc:datafield[@tag=773]">
        <span class="results_summary">
    <span class="label">Journal Source: </span>
